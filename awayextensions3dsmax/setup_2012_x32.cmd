@echo off
echo.
set programmname=3dsmax 2012 32 bit
echo AwayExtensions-3dsmax Installer for %programmname%
echo.
echo.
echo Detected pathes:
echo.
set programmpath=%ProgramFiles%\Autodesk\3ds Max 2012\

iF DEFINED ProgramFiles(x86) (set programmpath="%ProgramFiles(x86)%\Autodesk\3ds Max 2012\")

IF DEFINED ADSK_3DSMAX_x32_2012 (set programmpath="%ADSK_3DSMAX_x32_2012%")

set programmpath=%programmpath:"=%
set exportername=maxawdexporter_2012_32.dle
set toolbarname=AWDToolBar_2011_2012.CUI
set uninstallername=uninstall_awayextensions3dsmax_2012_x32.cuix
...
set localUIpath=%LOCALAPPDATA%\Autodesk\3dsMax\2012 - 32bit\enu\UI\
